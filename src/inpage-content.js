...
fbcTitle.textContent = browser.i18n.getMessage("linkedinContainer");
...
fbcPromptAllow.addEventListener("click", (e) => {
  ...
  // Launch linkedin authentication
...
fbcEmailAllow.addEventListener("click", (e) => {
  ...
  window.open("https://relay.firefox.com/?utm_source=firefox&utm_medium=addon&utm_campaign=LinkedIn%20Container&utm_content=Try%20Firefox%20Relay");
});
