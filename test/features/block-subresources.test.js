describe("Block SubResources", () => {
  ...
  describe("origin url is not linkedin", () => {
    ...
    it("should not block subresources if origin url is added to linkedin container", async () => {
      background.browser.storage.local.set({
        domainsAddedToLinkedInContainer: ["example.com"]
      });
  ...
  describe("origin url is linkedin", () => {
    it("should not block subresources", async () => {
      const promise = background.browser.webRequest.onBeforeRequest.addListener.secondCall.yield({
        url: "https://licdn.net",
        originUrl: "https://www.linkedin.com"
      });
  ...
  describe("request url is not linkedin", () => {
    it("should not block subresources", async () => {
      const promise = background.browser.webRequest.onBeforeRequest.addListener.secondCall.yield({
